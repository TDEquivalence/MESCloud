...
import com.tde.mescloud.security.config.httphandler.HttpResponse;
...
@RestControllerAdvice //this allows this class to behave like a controller but just to handle exception
public class ExceptionHandling implements ErrorController {

    private Logger LOGGER = LoggerFactory.getLogger(getClass()); // A logger for this class
